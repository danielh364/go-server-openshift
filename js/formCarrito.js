...
function openLoginModal() {
  document.getElementById("formulariorAcceso").style.display = 'block';
  document.getElementById("formNCuenta").style.display = 'none';
...
function openNCuentaModal() {
    document.getElementById("formulariorAcceso").style.display = 'none';
    document.getElementById("formNCuenta").style.display = 'block';
